<?php
    ...
    $res=mysqli_query($link,"SELECT s.id,s.price,s.date,p.name FROM sales s LEFT JOIN products p ON s.product_id = p.id ORDER BY s.date DESC");//seleccion de tablas
